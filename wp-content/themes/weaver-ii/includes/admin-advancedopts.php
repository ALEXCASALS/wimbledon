...
<p>
	This input area allows you to enter custom HTML such as &lt;link&gt; and &lt;meta&gt; code to your site.
	Code entered into this box is included right before the &lt;/HEAD&gt; HTML tag on each page of your site.
	Currently, this code can include JavaScript widget code supplied by other sites to provide some feature of the outside site. <span style="color:red;">Notice: After WordPress 3.9 is
    released, future versions of Weaver II will require you to use the <em>Weaver II Theme Extras</em> plugin or the
    <em>Weaver II Pro</em> theme
    to be able to add JavaScript to this section.</em></span> This is due to new WordPress.org theme standards.
	...
	<small>Note: You can add CSS Rules using the "Custom CSS Rules" option below.</small>
</p>
<p>
		...
		using the per page options from the page editor.
				...
				<textarea name="<?php weaverii_sapi_main_name('wii_head_opts'); ?>" rows=2 style="width: 95%"><?php weaverii_esc_textarea(weaverii_getopt('wii_head_opts')); ?></textarea>
<br>
